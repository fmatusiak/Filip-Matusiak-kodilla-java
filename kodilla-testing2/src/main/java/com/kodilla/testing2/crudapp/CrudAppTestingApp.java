...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_SUBMIT = "//html/body/main/section/form/fieldset[3]/button";
    ...
    public static void main(String[] args) {
        ...
        webDriver.get("https://fmatusiak.github.io/");
        ...
        /*WebElement submitField = webDriver.findElement(By.xpath(XPATH_SUBMIT));
        submitField.submit();
*/
